    ...
    <div class="col-lg-12 gradient-header">
        <div class="col-lg-8 border border-2 text-center gradient-custom" style="width: 100%; height: auto">
            <form method="post" class="d-flex justify-content-center">
                <fieldset>
                    <legend><h4>Edit Employee Information</h4></legend>
                    <table>
                        <tr>
                            <td>
                                    ...
                                    <select class="form-select" name="educationDegreeId">
                                        ...
                                        <c:forEach items="${educationDegrees}" var="educationDegree">
                                            <c:if test="${educationDegree.id == employee.educationDegreeId}">
                                                <option selected value="${educationDegree.id}">${educationDegree.name}</option>
                                            </c:if>
                                            <c:if test="${educationDegree.id != employee.educationDegreeId}">
...
<%--                                        <option value="" selected>Select Employee Username</option>--%>
