...
<div class="container-fluid">
    <div class="col-lg-12 gradient-header">
        <div class="text-center gradient-custom" style="width: 100%; height: auto">
            <div align="center">
                <caption><h2>List of Employee</h2>
                    <a class="btn btn-outline-secondary"
                       href="/employees?action=create">Create New Employee</a>
                </caption>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-outline-secondary" style="width: 71px"
                                   href="/employees?action=edit&id=${employee.getId()}">Edit</a>
                                <button class="btn btn-outline-secondary" type="button"
                                        onclick="infoDelete('${employee.getId()}','${employee.getName()}')"
